...
class _PyToPycPageState extends State<PyToPycPage> {
  ...
  final String apiUrl = 'https://your-flask-server.com/upload'; // غيّر هذا إلى رابط سيرفرك
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('تحويل .py إلى .pyc'),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('رفع وتحويل الملف'),
            ),
            if (downloadPath != null) ...[
              const SizedBox(height: 20),
              ElevatedButton(
                onPressed: () {
                  // يمكن إضافة فتح الملف أو مشاركته هنا حسب الحاجة
                },
